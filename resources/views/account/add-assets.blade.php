        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="ticket_second_box add_asset">
                    ...
                    <form action="{{route('storeassets')}}" id="demo-form" data-parsley-validate="" method="POST" enctype="multipart/form-data">
                        @csrf
                        <label for="fname">How do you want to call this asset?</label><br>
                        <input type="text" id="fname" name="assets_name" required="" class="form-control"><br>
                        <label for="lname">Paste the link of this asset here</label><br>
                        <input type="url" id="lname" name="assets_link" required="" class="form-control"><br>
