  ...
  <div class="container">
    <div class='row'>
      ...
      <div class='col-md-4'>
        ...
        <form  accept-charset="UTF-8" action="{{route('process')}}" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_test_51Jn0GYSCn9RmGB5DvmMHOu36CbYJFRpRbPpCGRmqUjLsK7DTBiOHdwQw7n1nzUBo4ds9sV1D1TTkmgfIWIjaoCsX0006wPGnYU" id="payment-form" method="post">
          @csrf
          <div class='form-row'>
